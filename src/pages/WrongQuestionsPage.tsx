...
import {
  ...
  toggleFavoriteUtil, addWrong, removeWrong, WRONG_KEY,
...
export default function WrongQuestionsPage() {
  ...
  /* Load data - filter wrong questions */
  useEffect(() => {
    fetch('/questions/questions_1_50.json')
      ...
      .then((data) => {
        ...
        const wrongIds: number[] = JSON.parse(localStorage.getItem(WRONG_KEY) || '[]');
        const wrongSorular = all.filter((s: Soru) => wrongIds.includes(s.soru_no));
        setSorular(wrongSorular);
  ...
  if (total === 0) {
    return (
      <div className="min-h-[100dvh] flex flex-col items-center justify-center bg-navy-900 px-6">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Tebrikler!</h2>
        <p className="text-gray-400 text-center">Henüz yanlış çözdüğünüz soru yok.</p>
        <button
      ...
      <div className="flex-1 overflow-y-auto pb-20 scrollbar-hide">
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            <span className="inline-flex items-center px-2.5 py-1 rounded-full bg-red-500 text-white text-xs font-bold">
